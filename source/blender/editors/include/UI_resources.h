...
typedef enum ThemeColorID {
  ...
  TH_PARTSLIST_SELECTED,
  TH_PARTSLIST_SELECTED_TEXT,
  TH_PARTSLIST_ERROR,
  TH_PARTSLIST_ERROR_TEXT,
  TH_PARTSLIST_WARNING,
  TH_PARTSLIST_WARNING_TEXT,
  TH_PARTSLIST_INFO,
  TH_PARTSLIST_INFO_TEXT,
  TH_PARTSLIST_DEBUG,
  TH_PARTSLIST_DEBUG_TEXT,
