...
#define USE_PARTSLIST_NEWLINE

static void partslist_report_color(unsigned char *fg,
                              unsigned char *bg,
                              Report *report,
                              const short do_tint)
{
...
{
  SpacePartslist *spartslist = (SpacePartslist *)tvc->arg1;
...
{
  Report *report = (Report *)tvc->iter;
  partslist_report_color(fg, bg, report, tvc->iter_tmp % 2);
  return TVC_LINE_FG | TVC_LINE_BG;
}

#else  // USE_PARTSLIST_NEWLINE
...
#undef USE_PARTSLIST_NEWLINE

static int partslist_textview_main__internal(struct SpacePartslist *spartslist,
                                        ARegion *ar,
                                        ReportList *reports,
                                        int draw,
                                        int mval[2],
...
void *partslist_text_pick(struct SpacePartslist *spartslist, ARegion *ar, ReportList *reports, int mouse_y)
{
  ...
  partslist_textview_main__internal(spartslist, ar, reports, 0, mval, &mouse_pick, NULL);
  return (void *)mouse_pick;
}

int partslist_textview_height(struct SpacePartslist *spartslist, ARegion *ar, ReportList *reports)
{
  int mval[2] = {INT_MAX, INT_MAX};
  return partslist_textview_main__internal(spartslist, ar, reports, 0, mval, NULL, NULL);
}

void partslist_textview_main(struct SpacePartslist *spartslist, ARegion *ar, ReportList *reports)
{
  int mval[2] = {INT_MAX, INT_MAX};
  partslist_textview_main__internal(spartslist, ar, reports, 1, mval, NULL, NULL);
}
